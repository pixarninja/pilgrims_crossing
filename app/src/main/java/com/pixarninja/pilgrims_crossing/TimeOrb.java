...
public class TimeOrb extends SpriteProp {

    public TimeOrb(SpriteView spriteView, Resources res, int width, int height, int xRes, int yRes, double xInit, double yInit, String ID) {
        ...
        try {
            switch (ID) {
                case "complete":
                    ...
                    render.setSpriteSheet(decodeSampledBitmapFromResource(res, R.mipmap.prop_time_orb, (int)(xSpriteRes * spriteScale), (int)(ySpriteRes * spriteScale)));

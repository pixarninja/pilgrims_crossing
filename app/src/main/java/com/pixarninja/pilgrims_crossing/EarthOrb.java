...
public class EarthOrb extends SpriteProp {

    public EarthOrb(SpriteView spriteView, Resources res, int width, int height, int xRes, int yRes, double xInit, double yInit, String ID) {
        ...
        try {
            switch (ID) {
                case "complete":
                    ...
                    render.setSpriteSheet(decodeSampledBitmapFromResource(res, R.mipmap.prop_earth_orb, (int)(xSpriteRes * spriteScale), (int)(ySpriteRes * spriteScale)));
